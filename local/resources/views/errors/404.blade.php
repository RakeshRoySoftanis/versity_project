...
.permission_denied {
  /*background: #24344c !important;*/
      background: linear-gradient(88deg, #F1663F, #632D83) !important;
}
...
<body class="permission_denied">
  ...
  <div class="denied__wrapper">
    <h1>404</h1>
    <h3>LOST IN <span>SPACE</span> Portal? Hmm, looks like that page doesn't exist.</h3>
