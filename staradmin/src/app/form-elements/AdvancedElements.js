...
const barEmptyStyle = {
    ...
    width: '12px',
    height: '28px',
    backgroundColor: 'rgba(63, 80, 246, 0.6)',
    margin: '1px'
}
...
const barFullStyle = {
    ...
    width: '12px',
    height: '28px',
    backgroundColor: 'rgba(63, 80, 246, 1)',
    margin: '1px'
}
...
const DefaultDatepicker = () => {
    ...
    return (
      <DatePicker selected={startDate} onChange={date => setStartDate(date)} className="form-control" style={{'z-index':3}} name="datepicker"/>
    );
};
