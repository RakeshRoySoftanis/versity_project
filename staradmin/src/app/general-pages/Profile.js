                ...
                <div className="row">
                  <div className="col-lg-4">
                    ...
                    <div className="border-bottom py-4">
                      <p>Skills</p>
                      <div>
                        <label className="badge badge-outline-dark mr-1">Chalk</label>
                        <label className="badge badge-outline-dark mr-1">Hand lettering</label>
                        <label className="badge badge-outline-dark mr-1">Information Design</label>
                        <label className="badge badge-outline-dark mr-1">Graphic Design</label>
                        <label className="badge badge-outline-dark mr-1">Web Design</label>  
                      </div>                                                               
                    </div>
                    <div className="border-bottom py-4">
                      <div className="mb-3">
