      ...
      <div>
              ...
              <div className="card-body">
                <div className="clearfix">
                  ...
                  <div className="float-right">
                    <p className="mb-0 text-right text-dark"><Trans>Total Revenue</Trans></p>
                ...
                <p className="text-muted mt-3 mb-0">
                  <i className="mdi mdi-alert-octagon ml-1" aria-hidden="true"></i> 65% <Trans>lower growth</Trans> </p>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 grid-margin stretch-card">
            <div className="card card-statistics">
              <div className="card-body">
                <div className="clearfix">
                  ...
                  <div className="float-right">
                    <p className="mb-0 text-right text-dark"><Trans>Orders</Trans></p>
                    <div className="fluid-container">
                ...
                <p className="text-muted mt-3 mb-0">
                  <i className="mdi mdi-bookmark-outline ml-1" aria-hidden="true"></i> <Trans>Product wise sales</Trans> </p>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 grid-margin stretch-card">
            <div className="card card-statistics">
              <div className="card-body">
                <div className="clearfix">
                  ...
                  <div className="float-right">
                    <p className="mb-0 text-right text-dark"><Trans>Sales</Trans></p>
                    <div className="fluid-container">
                ...
                <p className="text-muted mt-3 mb-0">
                  <i className="mdi mdi-calendar ml-1" aria-hidden="true"></i> <Trans>Weekly Sales</Trans> </p>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 grid-margin stretch-card">
            <div className="card card-statistics">
              <div className="card-body">
                <div className="clearfix">
                  ...
                  <div className="float-right">
                    <p className="mb-0 text-right text-dark"><Trans>Employees</Trans></p>
                    <div className="fluid-container">
                ...
                <p className="text-muted mt-3 mb-0">
                  <i className="mdi mdi-reload ml-1" aria-hidden="true"></i> <Trans>Product wise sales</Trans> </p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="card">
              <div className="card-body">
                <div className="d-flex justify-content-between align-items-center mb-4">
                  <h2 className="card-title mb-0"><Trans>Product Analysis</Trans></h2>
                  <div className="wrapper d-flex">
                    <div className="d-flex align-items-center ml-3">
                      <span className="dot-indicator bg-success"></span>
                      <p className="mb-0 mr-2 text-muted"><Trans>Product</Trans></p>
                    </div>
                    <div className="d-flex align-items-center">
                      <span className="dot-indicator bg-primary"></span>
                      <p className="mb-0 mr-2 text-muted"><Trans>Resources</Trans></p>
                    </div>
                  </div>
                </div>
        ...
        <div className="row">
              ...
              <div className="card-body">
                ...
                <form  className="add-items d-lg-flex" onSubmit={this.addTodo}>
                  <input 
                      ...
                      required />
                  <button type="submit" className="btn btn-primary font-weight-bold ml-0 mt-2 mt-lg-0"><Trans>Add</Trans></button>
                </form>
          ...
          <div className="col-xl-4 col-lg-6 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title"><Trans>Schedules</Trans></h4>
                <div className="shedule-list d-xl-flex align-items-center justify-content-between mb-3">
                  <h3>27 <Trans>Sep</Trans> 2018</h3>
                  <small>21 <Trans>Events</Trans></small>
                </div>
                <div className="event border-bottom py-3">
                  <p className="mb-2 font-weight-medium"><Trans>Skype call with alex</Trans></p>
                  <div className="d-flex align-items-center">
                    <div className="badge badge-success">3:45 <Trans>AM</Trans></div>
                    <small className="text-muted mr-2"><Trans>London</Trans>, <Trans>UK</Trans></small>
                ...
                <div className="event py-3 border-bottom">
                  <p className="mb-2 font-weight-medium"><Trans>Data Analysing with team</Trans></p>
                  <div className="d-flex  align-items-center">
                    <div className="badge badge-warning">12.30 <Trans>AM</Trans></div>
                    <small className="text-muted mr-2"><Trans>San Francisco</Trans>, <Trans>CA</Trans></small>
                    <div className="image-grouped ml-auto mt-2 mt-xl-0">
                ...
                <div className="event py-3">
                  <p className="mb-2 font-weight-medium"><Trans>Meeting with client</Trans></p>
                  <div className="d-flex  align-items-center">
                    <div className="badge badge-danger">4.15 <Trans>AM</Trans></div>
                    <small className="text-muted mr-2"><Trans>San Diego</Trans>, <Trans>CA</Trans></small>
                    <div className="image-grouped ml-auto mt-2 mt-xl-0">
                  ...
                  <div className="card-body">
                    <div className="d-flex w-100 h-100 justify-content-between align-items-center">
                      <div className="mr-auto">
                        ...
                        <p className="text-white"> <Trans>This Month</Trans></p>
                  ...
                  <div className="card-body">
                    <div className="revenue-item d-flex">
                      <div className="revenue-desc">
                        <h6><Trans>Member Profit</Trans></h6>
                        <p className="font-weight-light"> <Trans>Average Weekly Profit</Trans> </p>
                      </div>
                    ...
                    <div className="revenue-item d-flex">
                      <div className="revenue-desc">
                        <h6><Trans>Total Profit</Trans></h6>
                        <p className="font-weight-light"> <Trans>Weekly Customer Orders</Trans> </p>
                      </div>
                      <div className="revenue-amount">
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-md-7">
                    <h4 className="card-title font-weight-medium mb-0 d-none d-md-block"><Trans>Active Users</Trans></h4>
                    <div className="wrapper mt-4">
                      <div className="d-flex justify-content-between mb-2">
                        <div className="d-flex align-items-center">
                          <p className="mb-0 font-weight-medium">67,550</p>
                          <small className="text-muted mr-2"><Trans>Email account</Trans></small>
                        </div>
                    ...
                    <div className="wrapper mt-4">
                      <div className="d-flex justify-content-between mb-2">
                        <div className="d-flex align-items-center">
                          ...
                          <small className="text-muted mr-2"><Trans>Requests</Trans></small>
                        </div>
          ...
          <div className="col-sm-6 col-md-6 col-lg-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <div className="row">
                  <div className="col-md-7">
                    <h4 className="card-title font-weight-medium mb-3"><Trans>Amount Due</Trans></h4>
                    <h1 className="font-weight-medium mb-0 text-dark">$5998</h1>
                    <p className="text-muted"><Trans>Milestone Completed</Trans></p>
                    <p className="mb-0"><Trans>Payment for next week</Trans></p>
                  </div>
            ...
            <div className="card">
              <div className="card-body py-5">
                <div className="d-flex flex-row justify-content-center align-items">
                  ...
                  <div className="mr-3">
                    <h6 className="text-facebook font-weight-semibold mb-0">2.62 <Trans>Subscribers</Trans></h6>
                    <p className="text-muted card-text"><Trans>You main list growing</Trans></p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              <div className="card-body py-5">
                <div className="d-flex flex-row justify-content-center align-items">
                  ...
                  <div className="mr-3">
                    <h6 className="text-google font-weight-semibold mb-0">3.4k <Trans>Followers</Trans></h6>
                    <p className="text-muted card-text"><Trans>You main list growing</Trans></p>
                  </div>
                </div>
              </div>
            ...
            <div className="card">
              <div className="card-body py-5">
                <div className="d-flex flex-row justify-content-center align-items">
                  ...
                  <div className="mr-3">
                    <h6 className="text-twitter font-weight-semibold mb-0">3k <Trans>Followers</Trans></h6>
                    <p className="text-muted card-text"><Trans>You main list growing</Trans></p>
                  </div>
                </div>
              </div>
                  ...
                  <table className="table table-striped">
                    <thead>
                      <tr>
                        ...
                        <th> <Trans>Sales</Trans> </th>
                        <th> <Trans>Deadline</Trans> </th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
        ...
        <div className="row">
          <div className="col-12 grid-margin">
            <div className="card">
              <div className="card-body">
                <h5 className="card-title mb-4"><Trans>Manage Tickets</Trans></h5>
                <div className="fluid-container">
                  <div className="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                    ...
                    <div className="ticket-details col-md-9">
                      <div className="d-lg-flex">
                        <p className="text-dark font-weight-semibold mr-2 mb-0 no-wrap"><Trans>James</Trans> :</p>
                        <p className="text-primary mr-1 mb-0">[#23047]</p>
                        <p className="mb-0 ellipsis"><Trans>Donec rutrum congue leo eget malesuada</Trans>.</p>
                      </div>
                      <p className="text-gray ellipsis mb-2"><Trans>Donec rutrum congue leo eget malesuada</Trans>. <Trans>Quisque velit nisi</Trans>, <Trans>pretium ut lacinia in</Trans> <Trans>elementum id enim vivamus</Trans>. </p>
                      <div className="row text-gray d-md-flex d-none">
                        <div className="col-4 d-flex">
                          <small className="mb-0 mr-2 text-muted text-muted"><Trans>Last responded</Trans> :</small>
                          <small className="Last-responded mr-2 mb-0 text-muted text-muted">3 <Trans>hours ago</Trans></small>
                        </div>
                        <div className="col-4 d-flex">
                          <small className="mb-0 mr-2 text-muted text-muted"><Trans>Due in</Trans> :</small>
                          <small className="Last-responded mr-2 mb-0 text-muted text-muted">2 <Trans>Days</Trans></small>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="btn-group dropdown">
                        <Dropdown>
                          ...
                          <Dropdown.Menu className="navbar-dropdown preview-list">
                            <Dropdown.Item>
                            <Trans>Quick reply</Trans>
                            </Dropdown.Item>
                            <Dropdown.Item>
                            <Trans>Another action</Trans>
                            </Dropdown.Item>
                            <Dropdown.Item>
                            <Trans>Resolve Issue</Trans>
                            </Dropdown.Item>
                            <Dropdown.Item>
                  ...
                  <div className="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                    ...
                    <div className="ticket-details col-md-9">
                      <div className="d-lg-flex">
                        <p className="text-dark font-weight-semibold mr-2 mb-0 no-wrap"><Trans>Stella</Trans> :</p>
                        <p className="text-primary mr-1 mb-0">[#23135]</p>
                        <p className="mb-0 ellipsis"><Trans>Curabitur aliquet quam id dui posuere blandit</Trans>.</p>
                      </div>
                      <p className="text-gray ellipsis mb-2"><Trans>Pellentesque in ipsum id orci porta dapibus</Trans>. <Trans>Sed porttitor lectus nibh</Trans>. <Trans>Curabitur non nulla sit amet nisl</Trans>. </p>
                      <div className="row text-gray d-md-flex d-none">
                        <div className="col-4 d-flex">
                          <small className="mb-0 mr-2 text-muted"><Trans>Last responded</Trans> :</small>
                          <small className="Last-responded mr-2 mb-0 text-muted">3 <Trans>hours ago</Trans></small>
                        </div>
                        <div className="col-4 d-flex">
                          <small className="mb-0 mr-2 text-muted"><Trans>Due in</Trans> :</small>
                          <small className="Last-responded mr-2 mb-0 text-muted">2 <Trans>Days</Trans></small>
                        </div>
                      </div>
                    </div>
                    <div className="ticket-actions col-md-2">
                  ...
                  <div className="row ticket-card mt-3">
                    ...
                    <div className="ticket-details col-md-9">
                      <div className="d-lg-flex">
                        <p className="text-dark font-weight-semibold mr-2 mb-0 no-wrap"><Trans>John Doe</Trans> :</p>
                        <p className="text-primary mr-1 mb-0">[#23246]</p>
                        <p className="mb-0 ellipsis"><Trans>Mauris blandit aliquet elit eget tincidunt nibh pulvinar</Trans>.</p>
                      </div>
                      <p className="text-gray ellipsis mb-2"><Trans>Nulla quis lorem ut libero malesuada feugiat</Trans>. <Trans>Proin eget tortor risus</Trans>. <Trans>Lorem ipsum dolor sit amet</Trans>.</p>
                      <div className="row text-gray d-md-flex d-none">
                        <div className="col-4 d-flex">
                          <small className="mb-0 mr-2 text-muted"><Trans>Last responded</Trans> :</small>
                          <small className="Last-responded mr-2 mb-0 text-muted">3 <Trans>hours ago</Trans></small>
