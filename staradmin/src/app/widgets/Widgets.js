    ...
    return (
      <div>
        ...
        <div className="row">
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <img className="card-img-top" src={require("../../assets/images/samples/300x300/1.jpg")} alt="card images" />
              <div className="card-body pb-0">
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <img className="card-img-top" src={require("../../assets/images/samples/300x300/2.jpg")} alt="card images" />
              <div className="card-body pb-0">
                <p className="text-muted">RAGNAROCK- Museet for pop, Roskilde, Denmark</p>
                <h5>It’s good to start or finish the day with delicious pancakes :)</h5>
                <div className="d-flex align-items-center justify-content-between text-muted border-top py-3 mt-3">
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <img className="card-img-top" src={require("../../assets/images/samples/300x300/3.jpg")} alt="card images" />
              <div className="card-body pb-0">
                <p className="text-muted">RAGNAROCK- Museet for pop, Roskilde, Denmark</p>
                <h5>It’s good to start or finish the day with delicious pancakes :)</h5>
                <div className="d-flex align-items-center justify-content-between text-muted border-top py-3 mt-3">
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card aligner-wrapper">
              <div className="card-body">
                <div className="absolute left top bottom v-strock-2 bg-success"></div>
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card aligner-wrapper">
              <div className="card-body">
                <div className="absolute left top bottom v-strock-2 bg-primary"></div>
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card aligner-wrapper">
              <div className="card-body">
                <div className="absolute left top bottom v-strock-2 bg-danger"></div>
          ...
          <div className="col-12 col-md-6 col-lg-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-description mb-1">What's people doing right now</p>
              ...
              <div className="card-body">
                ...
                <div className="wrapper d-flex align-items-center py-2 border-bottom">
                  ...
                  <div className="wrapper ml-3">
                    <h6 className="ml-1 mb-1 text-dark">Stella Davidson</h6>
                ...
                <div className="wrapper d-flex align-items-center py-2 border-bottom">
                  ...
                  <div className="wrapper ml-3">
                    <h6 className="ml-1 mb-1 text-dark">Daniel Russel</h6>
                    <small className="text-muted mb-0">
                ...
                <div className="wrapper d-flex align-items-center py-2 border-bottom">
                  ...
                  <div className="wrapper ml-3">
                    <h6 className="ml-1 mb-1 text-dark">Bruno King</h6>
                    <small className="text-muted mb-0">
                ...
                <div className="wrapper d-flex align-items-center py-2 border-bottom">
                  ...
                  <div className="wrapper ml-3">
                    <h6 className="ml-1 mb-1 text-dark">David Moore</h6>
                    <small className="text-muted mb-0">
                ...
                <div className="wrapper d-flex align-items-center pt-2">
                  ...
                  <div className="wrapper ml-3">
                    <h6 className="ml-1 mb-1 text-dark">Rafell John</h6>
                    <small className="text-muted mb-0">
