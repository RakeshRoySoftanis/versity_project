...
import { API_BASE_URL, MASTER_PUBLIC_URL } from '../../../constants';
    ...
    return (
      <nav className="master sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul className="nav">
          ...
          <li className={this.isPathActive('/master/users') ? 'nav-item active' : 'nav-item'}>
            <Link className="nav-link" to={`${MASTER_PUBLIC_URL}/users`}>
